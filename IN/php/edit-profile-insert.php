...
$result1 = $mysqli->query("UPDATE `placementinformer`.`student` SET `NAME` = '$name', `BRANCH` = '$branch', `EMAIL` = '$email', `PHONE` = '$phone', `CGPA` = '$cgpa', `tenthPercent` = '$tenth', `twelthPercent` = '$twelth', `diplomapercent` = '$diploma', `BRANCH` = '$branch' WHERE `student`.`USN` = '$usn'");
